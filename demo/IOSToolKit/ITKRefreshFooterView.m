...
// 状态文字内容
static NSString *const ITKRefreshFooterStateIdleText = @"点击加载更多";
static NSString *const ITKRefreshFooterStateRefreshingText = @"正在加载..";
static NSString *const ITKRefreshFooterStateNoMoreDataText = @"已经是全部数据";
